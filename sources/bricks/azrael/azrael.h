 ...
 * 故事一：
 *   一个被恶魔禁锢的灵魂产生；
 *   死神拯救了这个灵魂，让灵魂发挥自身的作用，后来，灵魂堕落了（恶魔？返回值？）；
 *   另一个死神拯救了这个灵魂，让灵魂发挥自身的作用，后来，灵魂又堕落了（恶魔？参数？）；
 *   另一个死神拯救了这个灵魂，让灵魂发挥自身的作用，后来，灵魂又堕落了（地狱？容器？）；
 *   ...
 *   另一个死神拯救了这个灵魂，让灵魂发挥自身的作用，最终，死亡到来，死神解脱这个灵魂。
 *
 * 故事二：
 *   一个死神
 *   loop
...
public:
    ...
    Entity *soul()
    {
        return static_cast<Entity *>(AzraelWings::m_unique.get());
    }
